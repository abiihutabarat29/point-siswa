...
class SuratKeluarController extends Controller
{
    public function index(Request $request)
    {
                ...
                ->addColumn('action', function ($row) {
                    return '<div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <button type="button" class="dropdown-item" onclick="window.location=\'' . url('surat-keluar/download/' . $row->id) . '\'">
        ...
        return view('surat-keluar.index', compact('menu', 'klasifikasi'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file_surat')) {
            ...
            $surat->storeAs('public/surat-keluar', $fileSurat);
            if ($request->hidden_id) {
                $oldFile = SuratKeluar::find($request->hidden_id);
                Storage::delete('public/surat-keluar/' . $oldFile->file_surat);
            }
        ...
        return response()->json(['success' => 'Surat Keluar saved successfully.']);
    }
    ...
    public function destroy($id)
    {
        $data = SuratKeluar::find($id);
        if ($data) {
            Storage::delete('public/surat-keluar/' . $data->file_surat);
            $data->delete();
            return response()->json(['success' => 'Surat Keluar deleted successfully.']);
        }
        return response()->json(['error' => 'Surat Keluar tidak ditemukan.'], 404);
    }
    ...
    public function download($id)
    {
        ...
        $filePath = storage_path('app/public/surat-keluar/' . $data->file_surat);
        $fileName = $data->file;
